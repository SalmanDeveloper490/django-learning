"""
Django settings for tweetsadmin project.
...
SECRET_KEY = 'django-insecure-_d0cl9o^kbfmxknv(mh=@n#k3n6p**x#6n7*_a5y=w2_mjmn&e'
...
WSGI_APPLICATION = 'tweetsadmin.wsgi.application'
